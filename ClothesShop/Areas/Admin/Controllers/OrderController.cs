    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            OrderVM = new OrderDetailsVM()
            {
                ...
                OrderDetails = _unitOfWork.OrderDetails.GetAll(o => o.OrderId == id, includeProperties: "Product,Product.ImagesUrl,Product.Category,Product.Colors").ToList()
        ...
        public IActionResult UpdateOrderDetails()
        {
            ...
            orderHEaderFromDb.DeliveryMethod = OrderVM.OrderHeader.DeliveryMethod;
            orderHEaderFromDb.Comment = OrderVM.OrderHeader.Comment;
